...
class Page {
    ...
    public function show() {
        ...
        if($this->url){
            ...
            $url            =   U('',$parameter);
            // zxc修改开始
            $url = str_replace('Index/index/', 'index', $url);
            $url = str_replace('Article/index/', 'index', $url);
            $url = str_replace('pid', '-', $url);
            $url = str_replace('cid', '-', $url);
            $url = str_replace('p', '-', $url);
            $url = str_replace('/', '', $url);
            // zxc修改结束


            //$url = "index-".$parameter[pid]."-".$parameter[cid]."-".$parameter[p].".html";
        }
        //上下翻页字符串
