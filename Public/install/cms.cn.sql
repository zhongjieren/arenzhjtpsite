...
CREATE TABLE `ec_article` (
  ...
  `content` TEXT,
  `click` INT(11) DEFAULT 0 NOT NULL COMMENT '点击数',  
...
-- ----------------------------
INSERT INTO `ec_channel` VALUES ('6', '0', '6', 'about', '/Article/page/code/about', 'page', '2', '1', '关于博主', '', '', '', '<p>\r\n	一、基本信息\r\n</p>\r\n<pre class=\"prettyprint lang-html\">网名：小策一喋\r\n籍贯性格：湖南人 吃得苦/霸得蛮/耐得烦\r\n联系方式：QQ：331273345 / Phone：18910886243\r\n兴趣爱好：代码、美食、影视、旅游\r\n关于本博：本博客基于ThinkPHP(Widget/TagLib)、MySQL、mongoDB、Redis、B-JUI、jQuery(jQuery-Plugins)、Bootstrap、Json、Rewrite等技术自主开发\r\n工作经验：七年PHP、ThinkPHP开发及Linux系统运维经验，目前在北京一国企信息中心负责系统架构设计、核心功能开发及系统运维管理工作</pre>\r\n<p>\r\n	二、掌握技能\r\n</p>\r\n<pre class=\"prettyprint lang-html\">PHP：熟练PHP开发，熟练ThinkPHP（ThinkPHP功能封装/Widget微件/TabLib自定义标签）开发\r\nDataBase：熟练MySQL、mongoDB数据库安装配置及性能调优，熟悉MsSQL数据库使用\r\nUI：熟练Jquery、Jquery插件开发，熟练B-JUI、Bootstrap、DIV+CSS及PhotoShop使用\r\nLinux：熟练Linux命令，熟悉Bash Shell开发，熟练Linux系统中lnmp、vsftp、rsync、squid等软件安装配置，熟练Linux环境中nginx、memcache、redis负载均衡集群架构配置\r\nSVN/GIT：熟练Linux及Windows环境下SVN、GIT的安装配置及协同开发\r\n.NET：熟悉C# MVC3开发\r\n</pre>\r\n<p>\r\n	三、开源项目\r\n</p>\r\n<pre class=\"prettyprint lang-html\">NO.1：开源前端框架<a href=\"http://www.b-jui.com\" target=\"_blank\">B-JUI</a>（借鉴<a href=\"http://www.j-ui.com\" target=\"_blank\">J-UI</a>、结合Bootstrap、Jquery开发）开发团队核心成员 <a href=\"http://git.oschina.net/xknaan/B-JUI\" target=\"_blank\">GIT</a> \r\nNO.2：基于ThinkPHP、B-JUI和MySQL/mongoDB开发的开源内容管理系统<a href=\"http://www.topstack.cn\" target=\"_blank\">ewsdCMS</a> <a href=\"https://coding.net/u/xvpindex/p/ewsdCMS/git\" target=\"_blank\">GIT</a></pre>\r\n<p>\r\n	四、项目经验\r\n</p>\r\n<pre class=\"prettyprint lang-html\">NO.1：中**公司：综合业务信息管理系统（PHP、ThinkPHP+MySQL开发，B/S架构）\r\nNO.2：中**公司：综合业务信息管理系统辅助工具（C#+MySQL开发，C/S架构）\r\nNO.3：中**公司：焊接行业在线培训及考试系统（ThinkPHP+MySQL开发，B/S架构）\r\nNO.4：中**公司：民用核安全设备无损检验人员资格考试在线测试系统（C#+MsSQL开发，C/S架构）\r\nNO.5：国家**局：检测行业在线培训及考试系统（C#+MsSQL MVC3开发，B/S架构)\r\nNO.6：中**公司：党建云管理系统（ThinkPHP+MySQL+mongoDB开发，B/S架构）\r\nNO.7：N个公司/企业/自媒体网站\r\n</pre>',1,'0', NULL, '0', NULL, '1423016156');
INSERT INTO `ec_channel` VALUES ('1', '0', '1', 'index', '/', 'url', '2', '1', '网站首页', '网站建设,系统开发,网站优化,SEO,网站维护,域名服务,虚拟主机,VPS,服务器租用,服务器托管', '深圳易网时代信息技术有限公司是一家高科技软件开发服务提供商和网络运营商，公司以高科技为起点、以技术为核心、以强大的技术队伍为支撑，致力于为政府、企业、个人和网络提供商提供高技术含量的各类应用解决方案，网站系统开发和建设。', '', '<div class=\"myblock\">\n	<div class=\"header\">\n		公司简介\n	</div>\n	<ul>\n		<li>\n			易网时代网络科技是一家高科技软件开发服务提供商和网络运营商，公司以高科技为起点、以技术为核心、以强大的技术队伍为支撑\n		</li>\n		<li>\n			致力于为政府、企业、个人和网络提供商提供高技术含量的各类应用解决方案，网站系统开发和建设\n		</li>\n		<li>\n			易网时代网络科技拥有先进的技术实力和专业人才、优良的客户服务及其标准的国际化管理营销体系\n		</li>\n		<li>\n			在开发软件、互联网、网站建设应用和系统平台开发等方面始终保持领先地位，并获得了社会各行业的广泛赞誉和认同\n		</li>\n	</ul>\n</div>\n<div class=\"myblock\">\n	<div class=\"header\">\n		业务范围\n	</div>\n	<ul>\n		<li>\n			网站、自动办公系统OA、业务信息系统的规划及建设\n		</li>\n		<li>\n			域名申请、虚拟主机、VPS空间租用\n		</li>\n		<li>\n			网站的升级改造、优化及运行维护\n		</li>\n		<li>\n			DEDECMS系统、DEDEEIMS系统、DISCUZ系统、ThinkPHP框架等系统的技术支持\n		</li>\n		<li>\n			网站SEO优化、关键词排名\n		</li>\n	</ul>\n</div>',2, '0', NULL, '0', NULL, '1404110671');
INSERT INTO `ec_channel` VALUES ('2', '0', '2', 'ui', '#', 'article', '2', '1', '前端设计', NULL, NULL, NULL, NULL, 3, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('3', '0', '3', 'program', '/', 'article', '2', '1', '后端开发', NULL, NULL, NULL, NULL,4, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('4', '0', '4', 'server', '#', 'article', '2', '1', '系统运维', NULL, NULL, NULL, NULL,5, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('5', '0', '5', 'opinion', '/Article/index/code/opinion', 'article', '2', '1', '码农视角', NULL, NULL, NULL, NULL,6, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('7', '2', '0', 'jsjQuery', '/Article/index/code/jsjQuery', 'article', '2', '1', 'JS/jQuery', NULL, NULL, NULL, NULL, 7,'0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('8', '3', '4', '', '/Article/index/code/', 'article', '2', '1', 'Shell开发', '', '', '', '', 8,'0', NULL, NULL, NULL, '1418001526');
INSERT INTO `ec_channel` VALUES ('9', '2', '0', 'htmldivcss', '/Article/index/code/htmldivcss', 'article', '2', '1', 'html/div/css', NULL, NULL, NULL, NULL, 9,'0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('10', '3', '3', '', '/Article/index/code/', 'article', '2', '1', 'Python开发', '', '', '', '', 10, '0', NULL, NULL, NULL, '1418001322');
INSERT INTO `ec_channel` VALUES ('11', '2', '0', 'Bootstrap', '/Article/index/code/Bootstrap', 'article', '2', '1', 'Bootstrap', NULL, NULL, NULL, NULL, 11, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('12', '2', '0', 'photoshop', '/Article/index/code/photoshop', 'article', '2', '1', '图形处理', NULL, NULL, NULL, NULL, 12,'0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('13', '3', '1', '', '/Article/index/code/', 'article', '2', '1', 'PHP开发', NULL, NULL, NULL, NULL,13, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('14', '3', '2', '', '/Article/index/code/', 'article', '2', '1', 'ThinkPHP', NULL, NULL, NULL, NULL, 14,'0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('15', '4', '0', 'linux', '/Article/index/code/linux', 'article', '2', '1', 'Linux系统', NULL, NULL, NULL, NULL,15, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('16', '4', '0', 'windows', '/Article/index/code/windows', 'article', '2', '1', 'Windows系统', NULL, NULL, NULL, NULL,16, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('17', '4', '0', 'database', '/Article/index/code/database', 'article', '2', '1', '数据库', NULL, NULL, NULL, NULL, 17,'0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('18', '4', '0', 'structruing', '/Article/index/code/structruing', 'article', '2', '1', '架构设计', NULL, NULL, NULL, NULL, 18, '0', NULL, NULL, NULL, NULL);
INSERT INTO `ec_channel` VALUES ('19', '4', '0', 'soft', '/Article/index/code/soft', 'article', '2', '1', '工具软件', NULL, NULL, NULL, NULL,19, '0', NULL, NULL, NULL, NULL);
